...
public class LoadCloudStorageToBigqueryTask extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		bigqueryTableId = bigqueryTableId.replace(":", "_").replace("-", "_");
		...
		if (AnalysisUtility.areParametersValid(startMsStr)) {
			...
			AnalysisUtility.fetchCloudStorageLogUris(
					bucketName, String.format("%s_%s", exporterSet.getPrefix(), schemaHash), startMs, endMs, requestFactory, urisToProcess, false);
	...
	protected String getDefaultBigqueryFieldExporterSetBag() {
		return "com.streak.logging.analysis.exporters.BasicFieldExporterSetBag";
	}
}
